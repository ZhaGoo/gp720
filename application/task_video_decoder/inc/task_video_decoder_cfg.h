...
#define TIME_BASE_TICK_RATE			200 //100	//video timer frequency
...
#define PARSER_VID_BITSTREAM_SIZE	(150*1024)//102400 //16384 //byte
...
// AVI resolution definition.
#define AVI_RES_VGA   	1
#define AVI_RES_720P  	2
#define AVI_RES_1080P  	3
extern INT8U   g_AVI_resolution ;
