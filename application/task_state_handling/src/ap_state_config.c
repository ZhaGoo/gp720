...
void ap_state_config_LDW_to_defalt(void)
{
	...
	ap_LDW_set_by_config(LDW_CAR_TYPE,0);// 0 = 轎車, 1 = 休旅車, 2 = 特高車    , default = 0 
	ap_LDW_set_by_config(LDW_SENSITIVITY,1);// 敏感度, 0 = 低, 1 = 高           , default = 1
	ap_LDW_set_by_config(LDW_AREA_CHOICE,1);// 0 = 台灣, 1 = 大陸               , default = 1 
	ap_LDW_set_by_config(LDW_START_SPEED,1);// 啟動車速, 0 = high, 1 = low      , default = 1
