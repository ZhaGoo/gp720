...
{	
	...
	if(temp) {
		ap_state_handling_icon_show_cmd(ICON_CAPTURE_SEQUENCE, NULL, NULL);
	}
...
void video_capture_resolution_display(void)
{
	...
	if(ap_display_get_device()==DISP_DEV_TFT) { //TFT
		capture_resolution_str.pos_y = 35;
	} else { //TV
		capture_resolution_str.pos_y = 90;
	}
	...
	if (temp == 0) {
		...
		if(ap_display_get_device()==DISP_DEV_TFT) { //TFT
			capture_resolution_str.pos_x = TFT_WIDTH-ICON_CAPTURE_OFFSET-ASCII_draw_char_width*3;
		} else { //TV
		  #if TV_WIDTH == 720
			capture_resolution_str.pos_x = TV_WIDTH-45-ASCII_draw_char_width*3;
		  #elif TV_WIDTH == 640
			capture_resolution_str.pos_x = TV_WIDTH-20-ASCII_draw_char_width*3;
		  #endif
		}
	} else if (temp == 1) {
		...
		if(ap_display_get_device()==DISP_DEV_TFT) { //TFT
			capture_resolution_str.pos_x = TFT_WIDTH-ICON_CAPTURE_OFFSET-ASCII_draw_char_width*2;
		} else { //TV
		  #if TV_WIDTH == 720
			capture_resolution_str.pos_x = TV_WIDTH-45-ASCII_draw_char_width*2;
		  #elif TV_WIDTH == 640
			capture_resolution_str.pos_x = TV_WIDTH-20-ASCII_draw_char_width*2;
		  #endif
		}
	} else if (temp == 3) {
		...
		if(ap_display_get_device()==DISP_DEV_TFT) { //TFT
			capture_resolution_str.pos_x = TFT_WIDTH-ICON_CAPTURE_OFFSET-ASCII_draw_char_width*4;
		} else { //TV
		  #if TV_WIDTH == 720
			capture_resolution_str.pos_x = TV_WIDTH-45-ASCII_draw_char_width*4;
		  #elif TV_WIDTH == 640
			capture_resolution_str.pos_x = TV_WIDTH-20-ASCII_draw_char_width*4;
		  #endif
		}
	} else {
...
void left_capture_num_display(INT32U left_num)
{
	...
	if(ap_display_get_device()==DISP_DEV_TFT) { //TFT
		left_capture_num_str.pos_y = 5;
	} else { //TV
		left_capture_num_str.pos_y = 30;
	}
	...
	if(ap_display_get_device()==DISP_DEV_TFT) { //TFT
		left_capture_num_str.pos_x = TFT_WIDTH-ICON_CAPTURE_OFFSET-ASCII_draw_char_width*5;
	} else { //TV
	  #if TV_WIDTH == 720
		left_capture_num_str.pos_x = TV_WIDTH-45-ASCII_draw_char_width*5;
	  #elif TV_WIDTH == 640
		left_capture_num_str.pos_x = TV_WIDTH-15-ASCII_draw_char_width*5;
	  #endif
	}
