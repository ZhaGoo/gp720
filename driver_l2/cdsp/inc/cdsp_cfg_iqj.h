...
#define LENS_OV9712_4039  0
#define LENS_OV9712_8172  1

#define USE_SENSOR_LENS   LENS_OV9712_4039
 ...
 **************************************************************************/	
	...
	#define	TARGET_Y  				0x28	//Luminace
	#define TARGET_Y_LOW			(TARGET_Y/4)	//TARGET_Y_LOW = TARGET_Y/4  
	#define MAX_ANALOG_GAIN			8		//5.4		//3 ~ 5
...
**************************************************************************/	
	...
	//		Y_SCALE = 0x22, Y_OFFSET range = 0~-15,  
	//=========================================================================
	#define	DAYLIGHT_HUE_Y_OFFSET  	-6		//-128 ~ +127	
	...
	// DAYLIGHT_SAT_V_SCALE: Red,  upper 0x20: deep red,  less 0x20: light red
	//========================================================================= 
	#define	DAYLIGHT_SAT_U_SCALE  	0x30	//Default:0x20 	// blud
	#define	DAYLIGHT_SAT_V_SCALE  	0x48	//Default:0x20	// red
...
**************************************************************************/	
	...
	// DAYLIGHT_SAT_V_SCALE: Red,  upper 0x20: deep red,  less 0x20: light red
	//=========================================================================            		
	#define	NIGHT_SAT_U_SCALE  		0x20	//Default:0x20	// blud 0x40
	#define	NIGHT_SAT_V_SCALE  		0x20	//Default:0x20	// red  0x40
 ...
 **************************************************************************/	
  ...
  #if (USE_SENSOR_LENS == LENS_OV9712_4039)
...
**************************************************************************/	
	...
	// DAYLIGHT_SAT_V_SCALE: Red,  upper 0x20: deep red,  less 0x20: light red
	//========================================================================= 
	#define	DAYLIGHT_SAT_U_SCALE	0x28	//Default:0x20 	// blud
	#define	DAYLIGHT_SAT_V_SCALE	0x28	//Default:0x20	// red
...
**************************************************************************/		
	...
	// DAYLIGHT_SAT_V_SCALE: Red,  upper 0x20: deep red,  less 0x20: light red
	//=========================================================================             	
	#define	NIGHT_SAT_U_SCALE  		0x26	//Default:0x20	// blud
	#define	NIGHT_SAT_V_SCALE  		0x26	//Default:0x20	// red
  ...
  #elif (USE_SENSOR_LENS == LENS_OV9712_8172)
  
	#define	TARGET_Y  				0x40	//Luminace
	#define TARGET_Y_LOW			TARGET_Y/4 	//TARGET_Y_LOW = TARGET_Y/4  
	#define MAX_ANALOG_GAIN			4		//3 ~ 5
...
**************************************************************************/	
	...
	//========================================================================= 
	#define	DAYLIGHT_SAT_U_SCALE	0x30	//Default:0x20 	// blud
	#define	DAYLIGHT_SAT_V_SCALE	0x30	//Default:0x20	// red
