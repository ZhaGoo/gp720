...
#define GPDV_BOARD_VERSION				GPCV1248_V1_0
...
// GPIO
    ...
    #define SCCB_SCL						IO_A11  // Sensor I2C clock pin
    #define SCCB_SDA      				    IO_A10	// Sensor I2C data pin	
    
    #define I2C_SCL     					IO_A11	// G_Sensor I2C clock pin
    #define I2C_SDA      				    IO_A10	// G_Sensor I2C data pin
    ...
    #define HDMI_IN_DET                     IO_A9
    #define TFT_BL							IO_F15	
    #define SPEAKER_EN                      IO_A8
    
    #define IR_CTRL                         IO_B11   //ir light 
    #define LED                             IO_F15
	#define I80_TE_PIN						IO_A12	
	#define SDC_UPGRADE_ERASE_USER_CONFIG	0
...
#define SUPPORT_JTAG					CUSTOM_ON	// ICE
